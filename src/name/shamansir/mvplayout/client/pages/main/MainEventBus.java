package name.shamansir.mvplayout.client.pages.main;

import name.shamansir.mvplayout.client.pages.company.CompanyModule;
import name.shamansir.mvplayout.client.pages.main.presenter.MainPresenter;
import name.shamansir.mvplayout.client.pages.main.view.MainView;
import name.shamansir.mvplayout.client.pages.news.NewsModule;
import name.shamansir.mvplayout.client.pages.user.UserModule;
